...
#import "PJOtherButtonsView.h"
#import "PJRemoteMatchViewController.h"
#import "UIUtil.h"
...
@interface PJRemoteViewController ()
{
    ...
    IBOutlet UIButton* __weak _sourceSearchButton;
    ...
    PJOtherButtonsView* _otherButtonsView;
...
@implementation PJRemoteViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"PJOtherButtonsView" owner:nil options:nil] objectAtIndex:0];
...
- (void)viewDidLoad
{
    ...
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_SOURCESEARCH", @"key", _sourceSearchButton, @"value", nil]];
                   ...
                   ^{
                       ...
                       dispatch_async(dispatch_get_main_queue(),
                                      ^{
                                          ...
                                          if (array.count > 0)
                                          {
                                              PJRemoteMatchViewController* viewController = [[PJRemoteMatchViewController alloc] init];
