/*
 ============================================================================
 Name        : MP3RemoterViewController.m
 Version     : 1.0.0
 Copyright   : www.keruiyun.com
 Description : The mp3 remoter view controller
 ============================================================================
 */

#import "MP3RemoterViewController.h"
#import "LocalizedStringTool.h"
#import "MP3OtherButtonsView.h"
#import "MP3RemoterMatchViewController.h"
#import "UIUtil.h"
...
@interface MP3RemoterViewController()
{
    ...
    MP3OtherButtonsView* _otherButtonsView;
...
@implementation MP3RemoterViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"MP3OtherButtonsView" owner:nil options:nil] objectAtIndex:0];
...
- (IBAction)matchButtonClicked:(id)sender
{
    ...
    ^{
        ...
        ^{
            ...
            if (array.count > 0)
            {
                MP3RemoterMatchViewController* viewController = [[MP3RemoterMatchViewController alloc] init];
