...
#import "RobotOtherButtonsView.h"
...
@interface RobotRemoteViewController ()
{
    ...
    RobotOtherButtonsView* _otherButtonsView;
...
@implementation RobotRemoteViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"RobotOtherButtonsView" owner:nil options:nil] objectAtIndex:0];
                   ...
                   ^{
                       ...
                       dispatch_async(dispatch_get_main_queue(),
                                      ^{
                                          ...
                                          if (array.count > 0)
                                          {
                                              RobotRemoteMatchViewController* viewController = [[RobotRemoteMatchViewController alloc] init];
