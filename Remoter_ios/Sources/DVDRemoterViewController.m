/*
 ============================================================================
 Name        : DVDRemoterViewController.m
 Version     : 1.0.0
 Copyright   : www.keruiyun.com
 Description : The dvd remoter view controller
 ============================================================================
 */
...
@interface DVDRemoterViewController()
{
    ...
    DVDChannelNumberView* _numberView;
    DVDOtherButtonsView* _otherButtonsView;
...
@implementation DVDRemoterViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _numberView = [[[NSBundle mainBundle] loadNibNamed:@"DVDChannelNumberView" owner:nil options:nil] objectAtIndex:0];
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"DVDOtherButtonsView" owner:nil options:nil] objectAtIndex:0];
...
- (void)viewDidLoad
{
    ...
    [button2 setBackgroundImage:[UIImage imageNamed:L(@"ImageTakeOut")] forState:UIControlStateNormal];
...
- (IBAction)matchButtonClicked:(id)sender
{
    ...
    ^{
        ...
        ^{
            ...
            if (array.count > 0)
            {
                DVDRemoterMatchViewController* viewController = [[DVDRemoterMatchViewController alloc] init];
