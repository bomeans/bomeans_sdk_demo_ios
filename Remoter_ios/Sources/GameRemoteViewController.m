...
#import "GameRemoteMatchViewController.h"
#import "UIUtil.h"
...
@interface GameRemoteViewController ()
{
    IBOutlet UIScrollView* __weak _contentView;
    IBOutlet UIButton* __weak _powerButton;
    IBOutlet UIButton* __weak _menuButton;
    IBOutlet UIButton* __weak _previousButton;
    IBOutlet UIButton* __weak _nextButton;
    IBOutlet UIButton* __weak _playButton;
    IBOutlet UIButton* __weak _stopButton;
    IBOutlet UIButton* __weak _pauseButton;
    IBOutlet UIButton* __weak _skipReverseButton;
    IBOutlet UIButton* __weak _skipForwandButton;
    ...
    GameOtherButtonsView* _otherButtonsView;
...
@implementation GameRemoteViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"GameOtherButtonsView" owner:nil options:nil] objectAtIndex:0];
...
- (void)viewDidLoad
{
    ...
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_PREVIOUS", @"key", _previousButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_NEXT", @"key", _nextButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_PLAY", @"key", _playButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_STOP", @"key", _stopButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_PAUSE", @"key", _pauseButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_SKIP_REVERSE", @"key", _skipReverseButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_SKIP_FORWARD", @"key", _skipForwandButton, @"value", nil]];
    ...
    [button1 setBackgroundImage:[UIImage imageNamed:L(@"ImageMenu")] forState:UIControlStateNormal];
                   ...
                   ^{
                       ...
                       dispatch_async(dispatch_get_main_queue(),
                                      ^{
                                          ...
                                          if (array.count > 0)
                                          {
                                              GameRemoteMatchViewController* viewController = [[GameRemoteMatchViewController alloc] init];
