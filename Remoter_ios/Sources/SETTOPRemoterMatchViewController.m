/*
 ============================================================================
 Name        : SETTOPRemoterMatchViewController.m
 Version     : 1.0.0
...
@interface SETTOPRemoterMatchViewController()
{
...
@implementation SETTOPRemoterMatchViewController
...
- (void)viewDidLoad
{
    ...
    lable1.text = L(@"MatchTOPNote1");
    lable2.text = L(@"MatchACNote2");
    lable3.text = L(@"MatchACNote3");
    [_powerButton setTitle:L(@"PowerOnOff") forState:UIControlStateNormal];
