...
#define kFlatDatePickerHeaderHeight 0
...
#define kFlatDatePickerScrollViewItemHeight 32
...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColorScrollView = [UIColor whiteColor];
        ...
        self.fontColorLabel          = [UIColor blackColor];
        ...
        self.fontLabelSelected = [UIFont fontWithName:@"HelveticaNeue-Bold" size:20.0];
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if ([self initWithFrame:CGRectMake(0.0, 0.0, _parentView.frame.size.width, _parentView.frame.size.height)]) {
        _datePickerMode = FlatDatePickerModeDate;
...
-(void)setupControl {
    ...
    if (self.datePickerMode == FlatDatePickerModeTime) {
        ...
        [self buildSelectorHoursOffsetX:0.0 andWidth:((self.frame.size.width / 2.0) - kFlatDatePickerScrollViewLeftMargin)];
        [self buildSelectorMinutesOffsetX:(self.frame.size.width / 2.0) andWidth:((self.frame.size.width / 2.0) - kFlatDatePickerScrollViewLeftMargin)];
    }
