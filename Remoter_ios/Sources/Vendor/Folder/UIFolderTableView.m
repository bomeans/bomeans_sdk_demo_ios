...
@interface UIFolderTableView ()<CAAnimationDelegate>
                  ...
                  completionBlock:(FolderCompletionBlock)completionBlock
{
    ...
    self.contentSize = CGSizeMake(self.contentSize.width, self.contentSize.height+self.subClassContentView.frame.size.height);
}
...
- (void)performClose:(id)sender {
    ...
    [self animationDidStop:moveTop finished:YES];
