/*
 ============================================================================
 Name        : AMPRemoterViewController.m
 Version     : 1.0.0
 Copyright   : www.keruiyun.com
 Description : The AMP remoter view controller
 ============================================================================
 */

#import "AMPRemoterViewController.h"
#import "LocalizedStringTool.h"
#import "AMPChannelNumberView.h"
#import "AMPOtherButtonsView.h"
#import "AMPRemoterMatchViewController.h"
#import "UIUtil.h"
...
@interface AMPRemoterViewController()
{
    ...
    IBOutlet UIButton* __weak _forwardButton;
    IBOutlet UIButton* __weak _backwardButton;
    ...
    AMPChannelNumberView* _numberView;
    AMPOtherButtonsView* _otherButtonsView;
...
@implementation AMPRemoterViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _numberView = [[[NSBundle mainBundle] loadNibNamed:@"AMPChannelNumberView" owner:nil options:nil] objectAtIndex:0];
        _otherButtonsView = [[[NSBundle mainBundle] loadNibNamed:@"AMPOtherButtonsView" owner:nil options:nil] objectAtIndex:0];
...
- (void)viewDidLoad
{
    ...
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_PREVIOUS", @"key", _channelUpButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_NEXT", @"key", _channelDownButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_MUTING", @"key", _muteButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_SKIP_FORWARD", @"key", _forwardButton, @"value", nil]];
    [_keyArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:@"IR_KEY_SKIP_REVERSE", @"key", _backwardButton, @"value", nil]];
...
- (IBAction)matchButtonClicked:(id)sender
{
    ...
    ^{
        ...
        ^{
            ...
            if (array.count > 0)
            {
                AMPRemoterMatchViewController* viewController = [[AMPRemoterMatchViewController alloc] init];
